...
* DEV.md contains any information that would be useful for a developer to know about the project. It can be updated with design decisions, external references, or anything that is useful for the project outside the codebase that is not suitable as specification or user documentation.
...
* When versioning the poject, make sure the version gets updated appropriately folling Semantic Versioning
